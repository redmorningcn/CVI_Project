...
#define  PANEL_RECEIVEMESSAGE             6       /* control type: command, callback function: RecMessageCallback */
#define  PANEL_SENDMESSAGE                7       /* control type: command, callback function: SendMessageCallback */
#define  PANEL_COMMANDBUTTON              8       /* control type: command, callback function: TelephonelCallback */
#define  PANEL_TELEPHONEL                 9       /* control type: command, callback function: TelephonelCallback */
#define  PANEL_COMTEXT                    10      /* control type: textBox, callback function: (none) */
#define  PANEL_MESSAGE                    11      /* control type: textBox, callback function: (none) */
#define  PANEL_TIMER                      12      /* control type: timer, callback function: SysTickCallback */
